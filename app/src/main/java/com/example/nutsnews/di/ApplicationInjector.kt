package com.example.nutsnews.di
...
import com.example.nutsnews.di.base.Injectable
import com.example.nutsnews.di.component.DaggerAppComponent
...
object ApplicationInjector {
    ...
    fun init(app: NutsNewsApplication) {
